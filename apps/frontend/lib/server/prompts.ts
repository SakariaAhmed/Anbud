...
export function buildSolutionEvaluationPrompt() {
  return buildPromptTemplate({
    ...
    rules: [
      ...
      "Skill eksplisitte kundekrav fra avklaringspunkter og risikodrivere. Ikke kall SOC-ansvar, OT-telemetri, penalty cap, Oracle-refaktorering, merger-påvirkning eller eksterne API-avhengigheter for krav med mindre kilden selv sier skal/must/shall.",
