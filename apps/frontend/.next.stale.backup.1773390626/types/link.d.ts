...
declare namespace __next_route_internal_types__ {
  ...
  type DynamicRoutes<T extends string = string> = 
    | `/api/v1/bids/${SafeSlug<T>}`
    | `/api/v1/bids/${SafeSlug<T>}/analysis`
    | `/api/v1/bids/${SafeSlug<T>}/documents`
    | `/api/v1/bids/${SafeSlug<T>}/documents/${SafeSlug<T>}`
    | `/api/v1/bids/${SafeSlug<T>}/requirements`
    | `/api/v1/bids/${SafeSlug<T>}/requirements/${SafeSlug<T>}`
    | `/bids/${SafeSlug<T>}`
